...
for name,chance in [('realm_ruins',12),('realm_flora',2),('realm_resources',1),('waystone_shrine',32),('rift_observatory',48),('mourning_cathedral',40)]:
