...
terrain = add({'type':'minecraft:y_clamped_gradient','from_y':16,'to_y':150,'from_value':1.7,'to_value':-1.7}, add(mul(1.05,noise('strata',1,.3)),mul(.28,noise('fractures',1,1))))
...
for name,chance in [('realm_ruins',12),('realm_flora',2),('realm_resources',1),('waystone_shrine',32),('rift_observatory',48),('mourning_cathedral',40),('forgotten_memorial',18)]:
