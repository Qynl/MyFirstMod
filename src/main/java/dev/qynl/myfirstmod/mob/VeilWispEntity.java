...
public final class VeilWispEntity extends AnimalEntity {
    ...
    public static DefaultAttributeContainer.Builder attributes(){return AnimalEntity.createAnimalAttributes().add(EntityAttributes.GENERIC_MAX_HEALTH,6).add(EntityAttributes.GENERIC_MOVEMENT_SPEED,.08);}
