...
public final class UnitCommands {
    ...
    public static void register() { CommandRegistrationCallback.EVENT.register((dispatcher, registry, environment) -> dispatcher.register(CommandManager.literal("unit")
        ...
        .then(CommandManager.literal("set").then(CommandManager.argument("id",StringArgumentType.word()).then(CommandManager.literal("health").then(CommandManager.argument("value",FloatArgumentType.floatArg(1,1024)).executes(c -> setHealth(c.getSource(),StringArgumentType.getString(c,"id"),FloatArgumentType.getFloat(c,"value"))))).then(CommandManager.literal("damage").then(CommandManager.argument("value",FloatArgumentType.floatArg(0,1024)).executes(c -> setDamage(c.getSource(),StringArgumentType.getString(c,"id"),FloatArgumentType.getFloat(c,"value"))))).then(CommandManager.literal("speed").then(CommandManager.argument("value",FloatArgumentType.floatArg(0.001f,10)).executes(c -> setSpeed(c.getSource(),StringArgumentType.getString(c,"id"),FloatArgumentType.getFloat(c,"value"))))).then(CommandManager.literal("role").then(CommandManager.argument("value",StringArgumentType.word()).executes(c -> setRole(c.getSource(),StringArgumentType.getString(c,"id"),StringArgumentType.getString(c,"value"))))).then(CommandManager.literal("faction").then(CommandManager.argument("value",StringArgumentType.word()).executes(c -> setFaction(c.getSource(),StringArgumentType.getString(c,"id"),StringArgumentType.getString(c,"value"))))))).then(CommandManager.literal("equip").then(CommandManager.argument("id",StringArgumentType.word()).then(CommandManager.argument("slot",StringArgumentType.word()).then(CommandManager.argument("item",IdentifierArgumentType.identifier()).executes(c -> equip(c.getSource(),StringArgumentType.getString(c,"id"),StringArgumentType.getString(c,"slot"),IdentifierArgumentType.getIdentifier(c,"item")))))))
        .then(CommandManager.literal("faction").then(CommandManager.literal("create").then(CommandManager.argument("id",StringArgumentType.word()).then(CommandManager.argument("name",StringArgumentType.greedyString()).executes(c -> faction(c.getSource(),StringArgumentType.getString(c,"id"),StringArgumentType.getString(c,"name")))))).then(CommandManager.literal("relation").then(CommandManager.argument("from",StringArgumentType.word()).then(CommandManager.argument("to",StringArgumentType.word()).then(CommandManager.argument("relation",StringArgumentType.word()).executes(c -> relation(c.getSource(),StringArgumentType.getString(c,"from"),StringArgumentType.getString(c,"to"),StringArgumentType.getString(c,"relation")))))))); }
