...
public final class CreatorScreen extends HandledScreen<CreatorScreenHandler> {
    ...
    private void rebuild(){clearChildren(); int left=x+18, top=y+42;
        ...
        if(tab==0){button("New Guard",0,left,top);button("New Archer",1,left,top+27);button("Create Faction",2,left,top+54);button("Equip First",3,left,top+81);button("Duplicate First",4,left+205,top);button("Delete First",5,left+205,top+27);}
